...
The primary green threshold matches slice_spritesheet.py:
  g > 115  AND  (g - r) > 45  AND  (g - b) > 35

This egg-stage copy intentionally removes only clear green-screen pixels. Egg
edges can contain anti-aliased colors influenced by the green background; broad
"soft green" cleanup can delete valid edge pixels and make the egg look broken.
"""
